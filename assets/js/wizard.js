jQuery(document).ready(function($) {
    ...
    function showStep(step) {
        ...
        $('.converso-wizard-steps .step').removeClass('active');
        $('.converso-wizard-steps .step').each(function() {
    ...
    // Form Submission
    $('#converso-wizard-form').on('submit', function(e) {
        e.preventDefault();
        ...
        formData += '&action=converso_save_wizard&nonce=' + conversoWizard.nonce;

        $.ajax({
            url: conversoWizard.ajax_url,
            type: 'POST',
            data: formData,
            success: function(response) {
                if (response.success) {
                    window.location.href = conversoWizard.redirect_url;
                } else {
